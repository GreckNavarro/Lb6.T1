...
public class PatrolMovementController : MonoBehaviour
{
    ...
    {
        CheckNewPoint();
        /* Cambiamos la velocidad de la variable del animator, para que el personaje realice la animación de caminar */
        animatorController.SetVelocity(velocityCharacter: myRBD2.velocity.magnitude);
    }

    /* La función de CheckNewPoint se encarga de que el enemigo recorra todos los puntos que tenemos dentro del arreglo*/
    ...
    private void CheckNewPoint()
    {
        ...
        para luego dibujar un raycast en esa dirección */
